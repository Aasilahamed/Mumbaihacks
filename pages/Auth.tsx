...
import { HeartPulse, Mail, Lock, User, ArrowRight, ShieldCheck, Activity, Building2, CheckCircle2 } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <>
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      type="text" 
                      placeholder={role === 'patient' ? "John Doe" : "Admin Name"} 
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input 
                  type="email" 
                  placeholder={role === 'patient' ? "patient@example.com" : "admin@hospital.com"} 
                  className="w-full bg-white dark:bg-slate-800 dark:text-white border-slate-200 dark:border-slate-700 border rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all"
                  required 
          ...
          <div className="text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <button onClick={() => setIsLogin(!isLogin)} className="text-brand-600 dark:text-brand-400 font-bold hover:underline">
